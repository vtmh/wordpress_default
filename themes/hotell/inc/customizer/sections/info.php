...
function hotell_customizer_theme_info( $wp_customize ) {
    ...
    $theme_info = '<ul>';
	$theme_info .= sprintf( __( '<li>View demo: %1$sClick here.%2$s</li>', 'hotell' ),  '<a href="' . esc_url( 'https://glthemes.com/previews/?theme=hotell' ) . '" target="_blank">', '</a>' );
    ...
    $theme_info .= sprintf( __( '<li>Support ticket: %1$sClick here.%2$s</li>', 'hotell' ),  '<a href="' . esc_url( 'https://glthemes.com/support-ticket/' ) . '" target="_blank">', '</a>' );

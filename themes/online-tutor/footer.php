	        ...
	        <div class="site-info col-lg-7 col-md-7 col-12">
	            <div class="footer-menu-left">
					<?php if(! get_theme_mod('online_tutor_footer_text_setting') != ''){ ?>
					    <a href="<?php echo esc_url( __( 'https://wordpress.org/', 'online-tutor' ) ); ?>">
							<?php
					    ...
					    <span>
					       <a href="<?php echo esc_url( __( 'https://www.themagnifico.net/themes/free-tutor-wordpress-theme/', 'online-tutor' ) ); ?>"> 
					           	<?php

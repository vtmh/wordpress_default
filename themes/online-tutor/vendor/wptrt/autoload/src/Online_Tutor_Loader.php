...
class Online_Tutor_Loader {
	 ...
	 * @return void
	 */
	public function online_tutor_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function online_tutor_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function online_tutor_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function online_tutor_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->online_tutor_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function online_tutor_load( $class ) {

...
jQuery(document).ready(function () {
    ...
    aravalli_theme_controls.on('click', '.customizer-repeater-new-field', function () {
        ...
        {
        if(jQuery('#exist_aravalli_Content').val()>=3)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_aravalli_Content').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_aravalli_Content').val())+1;
         jQuery('#exist_aravalli_Content').val(new_service_add_val);  
        }
        }
    ...
    aravalli_theme_controls.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
                ...
                {
                jQuery('#exist_aravalli_Content').val(parseInt(jQuery('#exist_aravalli_Content').val())-1); 
                }
